...
import { thumbnailUpload } from '../config/multer.config';
...
router.post('/', authenticateAdmin, thumbnailUpload.single('thumbnail'), createGroupValidationRules, validate, createGroup);
